...
pub use crate::utils::rescue::{
    HASH_CYCLE_LENGTH, NUM_HASH_ROUNDS, STATE_WIDTH as HASH_STATE_WIDTH,
};
...
pub const BALANCE_CONSTRAINT_RES: usize = TRACE_WIDTH + 5;
/// Index of constraint for updating the sender's nonce
pub const NONCE_UPDATE_CONSTRAINT_RES: usize = TRACE_WIDTH + 6;
/// Beginning index of intermediate tree root equality constraints
pub const INT_ROOT_EQUALITY_RES: usize = TRACE_WIDTH + 7;
/// Beginning index of constraints for previous tree root matching
pub const PREV_TREE_MATCH_RES: usize = TRACE_WIDTH + 9;
